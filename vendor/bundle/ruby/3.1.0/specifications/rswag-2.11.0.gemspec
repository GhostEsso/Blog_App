...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<rswag-specs>.freeze, ["= 2.11.0"])
    s.add_runtime_dependency(%q<rswag-api>.freeze, ["= 2.11.0"])
    s.add_runtime_dependency(%q<rswag-ui>.freeze, ["= 2.11.0"])
  else
    s.add_dependency(%q<rswag-specs>.freeze, ["= 2.11.0"])
    s.add_dependency(%q<rswag-api>.freeze, ["= 2.11.0"])
    s.add_dependency(%q<rswag-ui>.freeze, ["= 2.11.0"])
  end
end
